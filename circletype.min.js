...
!(function(t, e) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define([], e)
			: 'object' == typeof exports ? (exports.CircleType = e()) : (t.CircleType = e());
			...
			t.exports = function(t) {
				return function(e, n) {
					...
					return f < 0 || f >= a
						? t ? '' : void 0
						: ((o = c.charCodeAt(f)),
							o < 55296 || o > 56319 || f + 1 === a || (u = c.charCodeAt(f + 1)) < 56320 || u > 57343
								? t ? c.charAt(f) : o
								: t ? c.slice(f, f + 2) : u - 56320 + ((o - 55296) << 10) + 65536);
				};
			};
		},
		function(t, e, n) {
				...
				return void 0 === t
					...
					: null === t
						...
						: 'string' == typeof (n = u((e = Object(t)), i))
							? n
							: o ? r(e) : 'Object' == (c = r(e)) && 'function' == typeof e.callee ? 'Arguments' : c;
			};
		},
		function(t, e, n) {
			var r = n(0)('iterator'),
						...
						o(t, [
							{
								...
								value: function(t) {
									return void 0 !== t
										? ((this._radius = _(this._minRadius, t)), this._invalidate(), this)
										: this._radius;
								}
							},
							{
							...
							},
							{
								...
								value: function() {
									...
									if (
										...
										var a =
											f > 180 ? (0, l.default)(e, f) : (0, l.default)(o, f) + this._lineHeight;
